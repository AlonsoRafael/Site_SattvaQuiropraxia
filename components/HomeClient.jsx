  ...
  return (
    <>
      ...
      <main>
        ...
        <div style={{ width: '100%', overflow: 'hidden', lineHeight: 0, backgroundColor: '#ffffff' }}>
          <svg viewBox="0 0 1200 120" preserveAspectRatio="none" style={{ display: 'block', width: '100%', height: 'clamp(20px, 5vw, 60px)' }}>
        ...
        <div style={{ width: '100%', overflow: 'hidden', lineHeight: 0, backgroundColor: '#faf8f5' }}>
          <svg viewBox="0 0 1200 120" preserveAspectRatio="none" style={{ display: 'block', width: '100%', height: 'clamp(20px, 5vw, 60px)', transform: 'rotateY(180deg)' }}>
        ...
        <div style={{ width: '100%', overflow: 'hidden', lineHeight: 0, backgroundColor: '#ffffff' }}>
          <svg viewBox="0 0 1200 120" preserveAspectRatio="none" style={{ display: 'block', width: '100%', height: 'clamp(50px, 10vw, 120px)' }}>
